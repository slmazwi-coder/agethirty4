...
const apps = [
  {
    ...
    description:
      "Moreki reimagines online shopping as a visual mall — browse stores, explore products, and shop across multiple vendors in one immersive digital space. Think of it as walking through a real mall, but from your phone.",
    icon: Store,
    features: [
      { icon: Eye, label: "Visual storefront browsing", desc: "Navigate through stores like you would in a physical mall" },
      { icon: Users, label: "Multi-vendor marketplace", desc: "Dozens of shops under one roof, each with their own branding" },
      { icon: Package, label: "Unified cart & checkout", desc: "Buy from multiple vendors in a single transaction" },
      { icon: Sparkles, label: "AI-powered recommendations", desc: "Smart suggestions based on your browsing and purchase history" },
    ],
    useCases: [
      "Shoppers who want a curated, visual shopping experience",
      "Small retailers looking for affordable online presence",
      "Vendors who want to reach customers without building their own site",
    ],
